...
# io = open("dominance.log","w"); lgr = Logging.ConsoleLogger(io, Base.CoreLogging.Debug);
# lgr = nothing; close(io);
...
# Save results
saveresults("plm-complex-wtn0-cpa", "Witness0", PARAMS, RelDom=RD, Cells=CC)
