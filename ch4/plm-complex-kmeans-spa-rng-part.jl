# Stochastic Perturbation Analysis: Clustering RNG
...
# Generate seeds for partition creation
seed!(PARAMS[:seed]);
...
# Save results
saveresults("plm-complex-kmeans-spa-rng-part", "PLM + K-Means", PARAMS, RelDom=RD, Cells=CC)
